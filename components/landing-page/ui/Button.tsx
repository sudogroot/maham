...
const variantStyles = {
  solid: {
    ...
    cyan: 'bg-cyan-500 text-white hover:bg-cyan-400 active:bg-cyan-600  focus-visible:outline-blue-600',
    darkcyan: 'bg-cyan-700 text-white hover:bg-cyan-400 active:bg-cyan-600  focus-visible:outline-blue-600',
    white:
