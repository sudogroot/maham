function LogoSvg(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    ...
    <svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <linearGradient id="paint0_linear_287_8" x1="1.4625" y1="37.5375" x2="39" y2="3.4125" gradientUnits="userSpaceOnUse">
          <stop offset="0.33" stop-color="#2BC9F3" />
          <stop offset="1" stop-color="#72F8D5" />
        </linearGradient>
...
export function Logo() {
  return (
    <div className="flex items-center justify-center gap-2">
      <LogoSvg />
      <span className="text-xl font-maven-pro font-medium">Maham</span>
    </div>
  )
}
